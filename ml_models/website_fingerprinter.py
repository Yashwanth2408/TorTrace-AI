...
def main():
    ...
    results = fingerprinter.analyze_traffic_patterns(patterns_file)
    
    if results:
        report_file = '../data/website_fingerprint_report.json'
        fingerprinter.generate_fingerprint_report(results, report_file)
